// src/pages/beneficiary/BenNotifications.tsx
...
const BenNotifications = () => {
  ...
  const getDefaultTitle = (type: string) => {
    switch(type) {
      ...
      case 'surplus': return 'New Food Surplus';
              ...
              filteredNotifications.map((notif) => (
                <div 
                  ...
                  className={`bg-white rounded-xl p-4 shadow-sm border transition-all hover:shadow-md cursor-pointer ${
                    !notif.read 
                      ? 'border-l-4 border-l-primary-500 bg-green-50/30' 
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap justify-between items-start gap-2">
                        ...
                        {!notif.read && processingId === notif.id ? (
                          <FaSpinner className="animate-spin text-green-500 flex-shrink-0" />
                        ) : !notif.read && (
...
export default BenNotifications;